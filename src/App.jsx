          ...
          <div className="relative flex-col flex-center gap-5 py-8 size-full">
            {!isForm ? (
              <>
                ...
                <Search />
                <Shortcut />
                <a href="/extension.zip" target="_blank"
                  className="fixed bottom-10 right-10 glassmorphism rounded-full px-4 py-2 text-xs md:text-base font-medium cursor-pointer transition-transform hover:scale-110">
                  Download Extension
                </a>
              </>
            ) : (
